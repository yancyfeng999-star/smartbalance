...
本地优先通用能力：首次启动与兼容性、设置安全迁移、诊断脱敏、本机恢复、检查更新需确认、异常安全模式


## 0.3.2 — 2026-08-14

补充 Apache-2.0 开源协议、仓库治理和贡献文档
...
- 本地优先通用能力：设置信封与安全迁移、诊断脱敏、本机恢复、检查更新需确认、安全模式、刷新生命周期。证据见 `docs/superpowers/verification/2026-08-14-mac-common-capabilities-verification.md`。
